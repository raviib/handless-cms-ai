...
const Details_page_Table = async ({ params, searchParams }) => {
    ...
    const { name = "not found", pageName = "", category = "", get_url = "", post_url = "", put_url = "", ShowExcel, isDateFilters, searchInputPlaceholder, sections: Page_Fields } = await getPageConfFields(page);
