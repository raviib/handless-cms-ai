...
export async function GET(request, { params }) {
    try {
        await dbConnect();
        const { jobs_opening_id } = await params;
        let data = await jobs_openingSchema.findById(jobs_opening_id); 
...
export async function PUT(request, { params }) {
    ...
    try {
        ...
        const data = await jobs_openingSchema.findByIdAndUpdate(
            jobs_opening_id,
...
export async function DELETE(request, { params }) {
    try {
        await dbConnect();
        const { jobs_opening_id } = await params;
        const data = await jobs_openingSchema.findByIdAndDelete(jobs_opening_id);
